""" Class grid_element was imported from tutorial 6 (https://github.com/M6AIP2021/tutorial-06-modewaal.git).
The code containing the "arrow path" and print statements were commented out, no changes.
"""
...
class GridElement:
    ...
    def draw_grid_element(self, surface):
        ...
        # # This draws an arrow to from the parent
